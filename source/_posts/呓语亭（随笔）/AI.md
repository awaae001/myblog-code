...
就如此，多入山般的数据干扰了中文互联网的环境，这也导致你早起bard对话中出现的：“百度文心一言”问题了，这是用AI来训练AI。
...
污染我问题其实很早以前就开始了，你也可以理解为外地的文化渗透以及国内平台的监管问题，平台禁止网页搜索引擎的爬虫爬取站点，禁止用户外链等问题，让本来就很大的中文互联网的链接性大大减弱，资源也更加难以收集。
...
嗯嘛嘛，那是不是说明，我们的AI在晚上九点的效率最高?应为这个时候美国那边块放假了，AI也要开始度假了
...
中文AI还有很长的路要走，但我们无可否认的是：中文AI的缺占有一席之地了。在现在的国际AI都是中译英在翻译为中文的操作要高端一些了。

我们将要面对的是AI对人类经济、政治、文化的全方位入侵，以及在抖音等短视频平台的推广之下的AI主播、AI视频无底线的擦边博眼球和赚流量等问题，以及将来的AI训练AI，人类不产出任何内容。AI换脸等技术眼见为实的时代也在2023正式宣告了它的死亡。
